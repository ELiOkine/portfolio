...
import DataScienceSection from '@/components/data-science/DataScienceSection';
...
export default function HomePage() {
 ...
 Hiring for product engineering or data &amp; AI? Start with the matching path, then dig into the case studies and live systems.
 </p>
 ...
 Full time, contract, product, design &amp; data
 </p>
