        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-end flex-1">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 pb-2 lg:pb-6">
            ...
            <motion.p
              ...
              className="text-lg md:text-xl text-muted-foreground max-w-md leading-relaxed mb-10"
            >
              I design and ship payment flows, operational dashboards, and product interfaces that hold up on real devices and unreliable networks.
            </motion.p>
            ...
            >
              ...
              <a href="#projects" className="inline-flex items-center gap-1.5 text-sm font-medium link-quiet">
                Selected work
            ...
            <motion.div
              ...
              className="mt-14 md:mt-20 flex items-center gap-6 text-[11px] uppercase tracking-[0.18em] text-muted-foreground"
            >
